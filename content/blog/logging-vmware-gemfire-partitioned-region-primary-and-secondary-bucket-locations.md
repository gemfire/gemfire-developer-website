...
This article is a companion to my [Logging VMware GemFire PartitionedRegion Entry Details Per Bucket](/blog/logging-vmware-gemfire-partitionedregion-entry-details-per-bucket/) article. It provides an example of a compact view of the primary and secondary bucket locations per server and redundancy zone.
