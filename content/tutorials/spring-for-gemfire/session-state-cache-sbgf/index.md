...
2. Add your Broadcom Maven Repository credentials.
    ...
    **Gradle**
    ...
    ```groovy
    gemfireRepoUsername=YOUR_BROADCOM_MAVEN_REPO_EMAIL
    gemfireRepoPassword=YOUR_BROADCOM_MAVEN_REPO_ACCESS_TOKEN
    ```
   **Maven**
