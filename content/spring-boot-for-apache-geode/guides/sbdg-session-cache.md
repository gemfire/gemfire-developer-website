...
---
 ...
 To deploy the Session State Example application on Kubernetes make sure you have [created a Tanzu GemFire cluster on Kubernetes](spring-boot-for-apache-geode/getting-started/set-up-tgf4k8s).
...
* Open the `build.gradle` file and update the the `bootBuildImage` section, with your Docker repository username. This will build an image with the name `docker.io/[YOUR DOCKER USERNAME]/notes-app:0.0.1-SNAPSHOT`.  
